...
def get_network():
    ...
    if platform.system() == "Windows":
        output = subprocess.check_output(
            'powershell "Get-NetIPAddress -AddressFamily IPv4 | Where-Object {$_.IPAddress -notlike \'169.254*\' -and $_.IPAddress -notlike \'127.*\'} | Select-Object -ExpandProperty IPAddress"',
            shell=True,
            text=True
        )

        ips = output.strip().splitlines()
